...
public class Parser {
    ...
    public static ASTNode fromFile(String filename) throws FileNotFoundException, UnsupportedEncodingException, LexicalException, ParseException {
        var tokens = Lexer.fromFile(filename);
        return Program.parse(new PeekTokenIterator(tokens.stream()));
    }
}
